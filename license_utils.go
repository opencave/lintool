...
// getLicenseHeaderTemplate returns the license header template for the specified license type
func getLicenseHeaderTemplate(licenseType LicenseType, year, owner string) string {
	switch licenseType {
	case Apache2:
